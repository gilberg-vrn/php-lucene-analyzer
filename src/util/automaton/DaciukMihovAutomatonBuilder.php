...
//   */
//  private $stateRegistry = []; //new HashMap<>();
//
//  /**
//   * Root automaton state.
//   * @var State
//   */
//  private $root = null; //new State();
//
//  /**
...
//   */
//  private static $comparator = null;//CharsRef::getUTF16SortedAsUTF8Comparator();
//
//  /**
...
//   */
//  public function add(CharsRef $current) {
...
//   */
//  public static function build($input): Automaton {
//              $builder = new DaciukMihovAutomatonBuilder();
//
//    $chars = []; //new char[0];
//    $ref = new CharsRef();
//    /** @var BytesRef $b */
...
//        $len = UnicodeUtil.UTF8toUTF16(b, chars);
//      ref.chars = chars;
//      ref.length = len;
//      builder.add(ref);
//    }
